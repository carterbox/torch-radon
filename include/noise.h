...
public:
  ...
  void emulate_readings(const float* sinogram,
                        int* readings,
                        const float signal,
                        const float density_normalization,
                        const uint width,
  ...
  void emulate_readings_multilevel(const float* sinogram,
                                   int* readings,
                                   const float* signal,
  ...
  void emulate_readings_new(const float* sinogram,
                            int* readings,
                            const float signal,
                            const float normal_std,
                            const int k,
