...
__global__ void
radon_backward_kernel(T* __restrict__ output,
...
template void
radon_backward_cuda<float>(const float* x,
                           const float* angles,
                           float* y,
                           TextureCache& tex_cache,
                           const VolumeCfg& vol_cfg,
...
template void
radon_backward_cuda<unsigned short>(const unsigned short* x,
                                    const float* angles,
                                    unsigned short* y,
                                    TextureCache& tex_cache,
                                    const VolumeCfg& vol_cfg,
...
__global__ void
radon_backward_kernel_3d(T* __restrict__ output,
                         cudaTextureObject_t texture,
                         const float* __restrict__ angles,
                         const VolumeCfg vol_cfg,
                         const ProjectionCfg proj_cfg)
...
template<typename T>
void
radon_backward_cuda_3d(const T* x,
                       const float* angles,
                       T* y,
                       TextureCache& tex_cache,
                       const VolumeCfg& vol_cfg,
...
template void
radon_backward_cuda_3d<float>(const float* x,
                              const float* angles,
                              float* y,
                              TextureCache& tex_cache,
                              const VolumeCfg& vol_cfg,
...
template void
radon_backward_cuda_3d<unsigned short>(const unsigned short* x,
                                       const float* angles,
                                       unsigned short* y,
                                       TextureCache& tex_cache,
                                       const VolumeCfg& vol_cfg,
