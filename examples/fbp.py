...
if __name__ == '__main__':
    ...
    Image.fromarray(to_255_numpy(s_par)).save(os.path.join(output_dir, 'sino_par_torchradonv2.png'))
    Image.fromarray(to_255_numpy(s_par_filt)).save(os.path.join(output_dir, 'sino_par_filt_torchradonv2.png'))
    Image.fromarray(to_255_numpy(x_par)).save(os.path.join(output_dir, 'recon_par_torchradonv2.png'))
